    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    @php
                        $projects = Auth::user()->supervisedProjects()->with('members')->latest()->get();
                    @endphp
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            @foreach($projects as $project)
                                <div class="border rounded-lg p-4">
                                    ...
                                    <p class="text-gray-600 text-sm mb-2">{{ Str::limit($project->description, 100) }}</p>
                                    <div class="flex justify-between items-center text-sm mb-2">
                                        <span>Team: {{ $project->members->count() }} members</span>
                    ...
                    @else
                        <p class="text-gray-500 text-center py-8">No projects assigned to you yet.</p>
                    @endif
                </div>
            </div>
        </div>
